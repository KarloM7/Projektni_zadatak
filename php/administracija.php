            ...
            if ($sesija) {
                ...
                if ($uspjesnaPrijava == TRUE && $admin == TRUE) {
                    echo "<div class='container text-center'>
                            <div class='row'>
                                <div class='col d-flex flex-column justify-content-center'>
                                    <p>Uspješno ste prijavljeni kao administrator " . $_SESSION['$username'] . ".</p>
                                </div>
                            </div>
                        </div>";
                    echo "<div class='container text-center'>
                    ...
                    echo "<div class='container text-center'>
                            <div class='row'>
                                <div class='col d-flex flex-column justify-content-center'>
                                    <p>Uspješno ste prijavljeni kao korisnik " . $_SESSION['$username'] . ", ali niste administrator.</p>
                                </div>
                            </div>
                        </div>";
                    ...
                    echo "<div class='container text-center'>
                            <div class='row'>
                                <div class='col d-flex flex-column justify-content-center'>
                                    <p>Korisničko ime ne postoji u bazi.<br>Registrirajte se pritiskom na gumb.</p>
                                </div>
                            </div>
                        </div>";
                    echo "<div class='container text-center'>
